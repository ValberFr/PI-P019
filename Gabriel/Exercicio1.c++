...
int main()
{
  ...
  cout << "\nMostrando itens do conjunto itens1:" << endl;
  itens1.imprimirItens();

  cout << "\nMostrando itens do conjunto itens2:" << endl;
  itens2.imprimirItens();

  cout << "\nRemovendo itens do conjunto itens1:" << endl;
  itens1.excluir("oculos");

  cout << "\nRemovendo itens do conjunto itens2:" << endl;
